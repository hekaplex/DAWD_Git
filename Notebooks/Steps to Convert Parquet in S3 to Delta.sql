...
CREATE SCHEMA parquet_to_delta;
USE SCHEMA parquet_to_delta;

-- COMMAND ----------

CREATE VOLUME mock_s3_bucket

-- COMMAND ----------

-- MAGIC %python
-- MAGIC spark.table("hive_metastore.labuser9215760_1740409368.movies").write.mode("overwrite").format("parquet").save("/Volumes/labuser9215760_1740409368/parquet_to_delta/mock_s3_bucket/movies")

-- COMMAND ----------

-- MAGIC %fs ls /Volumes/labuser9215760_1740409368/parquet_to_delta/mock_s3_bucket/movies

-- COMMAND ----------

-- MAGIC %python
-- MAGIC spark.table("hive_metastore.labuser9215760_1740409368.movies").write.mode("overwrite").format("delta").save("/Volumes/labuser9215760_1740409368/parquet_to_delta/mock_s3_bucket/movies_delta")

-- COMMAND ----------

CREATE TABLE hive_metastore.labuser9215760_1740409368.movies_delta USING DELTA LOCATION "dbfs:/Volumes/labuser9215760_1740409368/parquet_to_delta/mock_s3_bucket/movies_delta"

-- COMMAND ----------

ALTER TABLE hive_metastore.labuser9215760_1740409368.movies_delta
SET TBLPROPERTIES ('delta.enableChangeDataFeed' = 'true')

-- COMMAND ----------

CONVERT TO DELTA parquet.`/Volumes/labuser9215760_1740409368/parquet_to_delta/mock_s3_bucket/movies`

-- COMMAND ----------

CREATE TABLE hive_metastore.labuser9215760_1740409368.movies_ex_parquet USING DELTA LOCATION "dbfs:/Volumes/labuser9215760_1740409368/parquet_to_delta/mock_s3_bucket/movies"

-- COMMAND ----------

insert into hive_metastore.labuser9215760_1740409368.movies_ex_parquet
select * from hive_metastore.labuser9215760_1740409368.movies_ex_parquet
